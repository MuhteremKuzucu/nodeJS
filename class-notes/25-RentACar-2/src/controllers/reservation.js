...
module.exports = {
  ...
  create: async (req, res) => {
    ...
    */
    ...
    // öncelikle musait olan aracları bulmak için musait olmayanları bulalım
    // db startDate<query end date, db endDate>query startData
    ...
    if(userReservation){
      throw new CustomError("The user is already reserved another car for given dates ", 400)
    } 
  ...
  read: async (req, res) => {
    ...
    const data = await Reservation.findOne({ _id: req.params._id,...customFilter});
